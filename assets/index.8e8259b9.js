...
export default App;`),[r,a]=g.exports.useState({language:"javascript",theme:"light",value:l,onChange:n=>e(n),height:300,lineNumbers:!0,highlight:!0,spellCheck:!1,handleSpecialCharacters:!0,handleHistory:!0});return g.exports.useEffect(()=>{document.querySelectorAll("pre > code").forEach(n=>{const o=n.className.split("-")[1],i=n.innerText;n.innerHTML=pe(P.highlight(o,i)),n.classList.add("hljs")})},[]),_(Ie,{children:[c(Ae,{href:"https://github.com/yosefbeder/react-code-editor",fixed:!0,zIndex:10,target:"_blank"}),_("div",{className:"max-w-screen-sm mx-auto py-4 px-2",children:[_("section",{children:[_("h1",{className:"flex",children:[c(ue,{className:"w-11 h-11 text-blue-500 mr-4"}),"React-",c("span",{className:"text-blue-500",children:"ThrowCode"})]}),c("p",{className:"w-96",children:"A mini code-editor for small apps with the most essential features for a code editor!"})]}),_("section",{children:[c(we,{children:"Example"}),c(Ve,C(y({},r),{className:"editor rounded-md shadow-md border mb-4"})),_("div",{className:"grid sm:grid-cols-2 p-2 rounded-md shadow-md border bg-white mb-4",children:[c($,{isChecked:r.height!=="auto",onToggle:()=>a(n=>C(y({},n),{height:n.height==="auto"?300:"auto"})),children:"Explicit height (300px)"}),c($,{isChecked:r.theme==="dark",onToggle:()=>a(n=>C(y({},n),{theme:n.theme==="light"?"dark":"light"})),children:"Dark mode"}),c($,{isChecked:r.lineNumbers,onToggle:()=>a(n=>C(y({},n),{lineNumbers:!n.lineNumbers})),children:"Line numbers"}),c($,{isChecked:r.highlight,onToggle:()=>a(n=>C(y({},n),{highlight:!n.highlight})),children:"Highlight"}),c($,{isChecked:r.spellCheck,onToggle:()=>a(n=>C(y({},n),{spellCheck:!n.spellCheck})),children:"Spell check"}),c($,{isChecked:r.handleHistory,onToggle:()=>a(n=>C(y({},n),{handleHistory:!n.handleHistory})),children:"History handling"}),c($,{isChecked:r.handleSpecialCharacters,onToggle:()=>a(n=>C(y({},n),{handleSpecialCharacters:!n.handleSpecialCharacters})),children:"Special characters handling"})]}),_("div",{className:"flex gap-4 ",children:[_("a",{className:"button",href:"#getting-started",children:[c(Me,{className:"w-5 h-5"}),"Documentation"]}),_("a",{className:"button",href:"https://github.com/yosefbeder/react-code-editor",target:"_blank",children:[c(ue,{className:"w-5 h-5"}),"Source code"]})]})]}),c(De,{components:{h2:we,h3:Je,a:et},children:c(fe,{})})]})]})}He.render(c(D.StrictMode,{children:c(tt,{})}),document.getElementById("root"));
