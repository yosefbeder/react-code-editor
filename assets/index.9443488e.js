var Ee=Object.defineProperty,Se=Object.defineProperties;var Le=Object.getOwnPropertyDescriptors;var Q=Object.getOwnPropertySymbols;var de=Object.prototype.hasOwnProperty,ce=Object.prototype.propertyIsEnumerable;var he=(o,e,r)=>e in o?Ee(o,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):o[e]=r,b=(o,e)=>{for(var r in e||(e={}))de.call(e,r)&&he(o,r,e[r]);if(Q)for(var r of Q(e))ce.call(e,r)&&he(o,r,e[r]);return o},x=(o,e)=>Se(o,Le(e));var re=(o,e)=>{var r={};for(var a in o)de.call(o,a)&&e.indexOf(a)<0&&(r[a]=o[a]);if(o!=null&&Q)for(var a of Q(o))e.indexOf(a)<0&&ce.call(o,a)&&(r[a]=o[a]);return r};import{r as g,l as F,t as pe,R as M,c as t,b as je,j as Ie,a as Ae,x as De,d as _,F as Me,e as c,g as He,C as ue,D as Oe,M as Re,L as ge,f as Ke}from"./vendor.ad2631ff.js";const Fe=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function r(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerpolicy&&(s.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?s.credentials="include":n.crossorigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(n){if(n.ep)return;n.ep=!0;const s=r(n);fetch(n.href,s)}};Fe();var k=["{","[","("],P=["}","]",")"],L="`",X=['"',"'"],Be=[].concat(k,P,X,[L]),w=function(){var e=window.getSelection(),r=0,a=0;if(e){var n=[e.anchorOffset,e.focusOffset];if(r=n[0],a=n[1],r>a){var s=[a,r];r=s[0],a=s[1]}}return{start:r,end:a}},p=function(e,r){var a=e.start,n=e.end,s=window.getSelection();if(s){if(r)s.setBaseAndExtent(r,a,r,n);else if(s.anchorNode){var i;s.anchorNode.nodeType===Node.TEXT_NODE?i=s.anchorNode:i=s.anchorNode.childNodes[0],s.setBaseAndExtent(i,a,i,n)}}},S=function(e,r){var a=e.start;return r.slice(0,a)},G=function(e,r){var a=e.end;return r.slice(a)},me=function(e,r){var a=e.start,n,s=!r.slice(0,a).includes(`
`);if(s)r.slice(a).includes(`
`)?n=r.slice(0,r.indexOf(`
`)):n=r;else{var i=r.slice(0,a).lastIndexOf(`
`),d=r.indexOf(`
`,a);d!==-1?n=r.slice(i+1,d):n=r.slice(i+1)}return n},Pe=function(e){for(var r=0,a=0;a<e.length&&/\t/.test(e[a]);a++)r++;return"	".repeat(r)},$e=function(e){var r=w(),a=S(r,e),n;return n=Pe(me(r,e)),(k.slice(0,2).includes(a[a.length-1])||a[a.length-1]===L)&&(n=n+"	"),n},T=function(e,r){var a=w(),n=S(a,r.innerText),s=G(a,r.innerText),i=document.createTextNode(""+n+e+s);r.innerHTML="",r.appendChild(i)},ze=function(e,r,a,n){var s=w(),i=S(s,e.innerText),d=G(s,e.innerText),u=$e(e.innerText),C;if(u){var j=k.includes(i[i.length-1])&&d[0]===P[k.indexOf(i[i.length-1])],H=i[i.length-1]===L&&d[0]===L;C=`
`+u+(j||H?`
`+u.slice(0,-1):"")}else C=`
`;T(C,e);var I=i.length+1+u.length;if(p({start:I,end:I}),n(e.innerText,{start:I,end:I}),r.scrollLeft=0,!a){var m=parseInt(getComputedStyle(e).getPropertyValue("line-height")),O=S(w(),e.innerText).split("").reduce(function(A,D){return/\n/g.test(D)?A+1:A},0)+1,f=parseInt(getComputedStyle(e).getPropertyValue("padding-top"));O*m>r.scrollTop+r.clientHeight&&(r.scrollTop=O*m+f-r.clientHeight)}},Ue=function(e,r){var a=w(),n=S(a,e.innerText),s=G(a,e.innerText);if(r.shiftKey){if(n[n.length-1]==="	"){var i=document.createTextNode(""+n.slice(0,n.length-1)+s);e.innerHTML="",e.appendChild(i);var d=n.length-1;p({start:d,end:d})}}else{T("	",e);var u=n.length+1;p({start:u,end:u})}},We=function(e,r,a){var n=window.getSelection(),s=w(),i=r.key,d=S(s,e.innerText),u=G(s,e.innerText);if(n.type==="Caret"){var C=me(s,e.innerText);if(k.includes(i)){r.preventDefault(),T(""+i+P[k.indexOf(i)],e);var j=d.length+1;p({start:j,end:j}),a(e.innerText,{start:j,end:j})}if(P.includes(i)&&u[0]===i){r.preventDefault();var H=d.length+1;p({start:H,end:H})}if(X.includes(i)){r.preventDefault();var I=C.split("").reduce(function(N,R){return R===i?N+1:N},0)%2==0,m=d.length+1;I?u[0]!==i?(T(i.repeat(2),e),p({start:m,end:m}),a(e.innerText,{start:m,end:m})):p({start:m,end:m}):(T(i,e),p({start:m,end:m}))}if(i===L){r.preventDefault();var O=e.innerText.split("").reduce(function(N,R){return R===L?N+1:N},0)%2==0,f=d.length+1;O?d[0]!==i?(T(i.repeat(2),e),p({start:f,end:f}),a(e.innerText,{start:f,end:f})):p({start:f,end:f}):(T(i,e),e.innerHTML=""+d+i+u,p({start:f,end:f}))}}if(n.type==="Range"){var A=e.innerText.slice(d.length,e.innerText.length-u.length),D,Y=k.includes(i),q=[].concat(X,[L]).includes(i);if(Y&&(D=P[k.indexOf(i)]),q&&(D=i),Y||q){r.preventDefault(),T(""+i+A+D,e);var $={start:d.length+1,end:d.length+A.length+1};p($),a(e.innerText,$)}}},Xe=function(e,r){var a=w(),n=S(a,e.innerText),s=G(a,e.innerText),i=k.includes(n[n.length-1])&&s[0]===P[k.indexOf(n[n.length-1])],d=[].concat(X,[L]).includes(n[n.length-1])&&s[0]===n[n.length-1];if(i||d){r.preventDefault();var u=document.createTextNode(""+n.slice(0,-1)+s.slice(1));e.innerHTML="",e.appendChild(u);var C=n.length-1;p({start:C,end:C})}},Ge=function(e,r){return r.type===0?{past:[].concat(e.past,[e.present]),present:r.payload,future:[]}:r.type===1&&e.past.length?{past:e.past.slice(0,-1),present:e.past[e.past.length-1],future:[e.present].concat(e.future)}:r.type===2&&e.future.length?{past:[].concat(e.past,[e.present]),present:e.future[0],future:e.future.slice(1)}:e},Ye={past:[],present:{text:"",position:{start:0,end:0}},future:[]},ne=function(e,r,a){var n=w(),s=S(n,e.innerHTML);T(r,e);var i=s.length+1;p({start:i,end:i}),a(e.innerText,{start:i,end:i})},qe=function(e,r){var a=w(),n=S(a,e.innerText);r(e.innerText,a),T("",e);var s=n.length;p({start:s,end:s})};function Ve(o,e){e===void 0&&(e={});var r=e.insertAt;if(!(!o||typeof document=="undefined")){var a=document.head||document.getElementsByTagName("head")[0],n=document.createElement("style");n.type="text/css",r==="top"&&a.firstChild?a.insertBefore(n,a.firstChild):a.appendChild(n),n.styleSheet?n.styleSheet.cssText=o:n.appendChild(document.createTextNode(o))}}var Qe=`@charset "UTF-8";
...
export default App;`),[r,a]=g.exports.useState({language:"javascript",theme:"light",value:o,onChange:n=>e(n),height:300,lineNumbers:!0,highlight:!0,spellCheck:!1,handleSpecialCharacters:!0,handleHistory:!0});return g.exports.useEffect(()=>{document.querySelectorAll("pre > code").forEach(n=>{const s=n.className.split("-")[1],i=n.innerText;n.innerHTML=pe(F.highlight(s,i)),n.classList.add("hljs")})},[]),_(Me,{children:[c(He,{href:"https://github.com/yosefbeder/react-code-editor",fixed:!0,zIndex:10,target:"_blank"}),_("div",{className:"max-w-screen-sm mx-auto py-4 px-2",children:[_("section",{children:[_("h1",{className:"flex",children:[c(ue,{className:"w-11 h-11 text-blue-500 mr-4"}),"React-",c("span",{className:"text-blue-500",children:"ThrowCode"})]}),c("p",{className:"w-96",children:"The perfect choice for throwing some code that other people can play with! \u{1F469}\u200D\u{1F4BB}"})]}),_("section",{children:[c(we,{children:"Example"}),c(Je,x(b({},r),{className:"editor rounded-md shadow-md border mb-4"})),_("div",{className:"grid sm:grid-cols-2 p-2 rounded-md shadow-md border bg-white mb-4",children:[c(B,{isChecked:r.height!=="auto",onToggle:()=>a(n=>x(b({},n),{height:n.height==="auto"?300:"auto"})),children:"Explicit height (300px)"}),c(B,{isChecked:r.theme==="dark",onToggle:()=>a(n=>x(b({},n),{theme:n.theme==="light"?"dark":"light"})),children:"Dark mode"}),c(B,{isChecked:r.lineNumbers,onToggle:()=>a(n=>x(b({},n),{lineNumbers:!n.lineNumbers})),children:"Line numbers"}),c(B,{isChecked:r.highlight,onToggle:()=>a(n=>x(b({},n),{highlight:!n.highlight})),children:"Highlight"}),c(B,{isChecked:r.spellCheck,onToggle:()=>a(n=>x(b({},n),{spellCheck:!n.spellCheck})),children:"Spell check"}),c(B,{isChecked:r.handleHistory,onToggle:()=>a(n=>x(b({},n),{handleHistory:!n.handleHistory})),children:"History handling"}),c(B,{isChecked:r.handleSpecialCharacters,onToggle:()=>a(n=>x(b({},n),{handleSpecialCharacters:!n.handleSpecialCharacters})),children:"Special characters handling"})]}),_("div",{className:"flex gap-4 ",children:[_("a",{className:"button",href:"#getting-started",children:[c(Oe,{className:"w-5 h-5"}),"Documentation"]}),_("a",{className:"button",href:"https://github.com/yosefbeder/react-code-editor",target:"_blank",children:[c(ue,{className:"w-5 h-5"}),"Source code"]})]})]}),c(Re,{components:{h2:we,h3:rt,a:nt},children:c(fe,{})})]})]})}Ke.render(c(M.StrictMode,{children:c(at,{})}),document.getElementById("root"));
